...
#define k_AttriText(f,c,t)  [[NSAttributedString alloc] initWithString:t attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:f],NSForegroundColorAttributeName: c}]
