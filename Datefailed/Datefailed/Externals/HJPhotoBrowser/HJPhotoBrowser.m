...
- (void)setupToolbars
{
    ...
    ///返回按钮
    UIImageView *backIM = [[UIImageView alloc] initWithFrame:CGRectMake(20, 20, 20, 20)];
    backIM.image = [UIImage imageNamed:@"back_third_used"];
    backIM.backgroundColor = [UIColor clearColor];
    backIM.alpha = 0.6;
    backIM.layer.cornerRadius = 5;
    backIM.userInteractionEnabled = YES;
    UITapGestureRecognizer *singleTap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(backAction:)];
    [backIM addGestureRecognizer:singleTap];
    _backIM = backIM;
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    _backIM.hidden = YES;
    _backIM.image = [UIImage imageNamed:@" "];
